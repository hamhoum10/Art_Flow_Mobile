...
//                "id= " + id +
    ...
    public stock(int id, String name, String artiste, String addres , String date_entr, int id_commende, String user_name) {
        this.id = id;
        this.name = name;
      ...
      public stock( String name, String artiste, String addres , String date_entr, int id_commende, String user_name) {
