    ...
    ReservationService as = ReservationService.getInstance();
      ...
      //  String url = l.getImage();
       ...
       // imgs = URLImage.createToStorage(enc, url, url, URLImage.RESIZE_SCALE);
        ...
        Label title = new Label(l.getDateres());
           System.out.println(l.getId());
            System.out.println(l.getNb_place());
             System.out.println(l.getDateres());
       TextField Nombreplace = new TextField("nbplace: " + l.getNb_place());
        Nombreplace.setEditable(false);
        Nombreplace.setUIID("Label");
        
         TextField dateEvent = new TextField("dateEvent: " + l.getDateres());
